...
def build_min_heap(arr):
    ...
    This method does not return a copy of the provided `Array` whose elements make up a heap, it modifies it in place.
    ...
    Args:
        arr: The input `Array`. Its elements should be comparable with `<`, `>=`, etc.
